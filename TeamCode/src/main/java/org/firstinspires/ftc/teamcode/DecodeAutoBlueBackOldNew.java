...
@Autonomous(name="DecodeAutoBlueBackOldNew", group="Decode")
public  class DecodeAutoBlueBackOldNew extends OpMode {
    ...
    public void loop() {
        ...
        switch (autonomousState) {
            ...
            case DRIVETONEXTBALLSX:
                ...
                if (drive(0.8, -42.0, DistanceUnit.INCH, 0.2)) {
                    resetDriveFlags();
